...
<li class="wpeo-add-point">
	<ul>
		...
		<li>
			<div class="wpeo-tasks-add-new-point" title="<?php _e( 'Add this point', 'wpeotasks-i18n' ); ?>" <?php echo (!$task->informations->user_can_write) ? 'disabled' : ''; ?> data-nonce="<?php echo wp_create_nonce( 'nonce_add_point' ); ?>">
