...
/** Define */
DEFINE( 'WPEOMTM_TASK_VERSION', 1.0 );
...
require_once( WPEOMTM_TASK_PATH . '/controller/wpeo_tasks_users_ctr.php' );
require_once( WPEOMTM_TASK_PATH . '/controller/wpeo_tasks_tags_ctr.php' );
...
require_once( WPEOMTM_TASK_PATH . '/model/wpeo_tasks_users_mod.php' );
require_once( WPEOMTM_TASK_PATH . '/model/wpeo_tasks_tags_mod.php' );

new wpeo_tasks_tags_ctr();
new wpeo_tasks_points_ctr();
new wpeo_tasks_users_ctr();
